...
export async function POST({ request }) {
    try {
        ...
        let prompt = '';
        if (body.type === 'manual') {
            prompt = `Bertindaklah sebagai Senior Product Manager. Buatkan Product Requirements Document (PRD) yang profesional dan terstruktur dengan rapi dalam format Markdown berdasarkan deskripsi aplikasi berikut:
...
5. Rencana Pengembangan (Roadmap)`;
            ...
            prompt = `Bertindaklah sebagai Senior Product Manager. Buatkan Product Requirements Document (PRD) yang profesional dalam format Markdown untuk membuat versi *clone* atau aplikasi serupa dari website referensi berikut.
...
5. Kebutuhan Spesifikasi Teknis`;
        } else {
