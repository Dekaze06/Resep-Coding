...
const targetFilePath = 'c:/Users/Akamale/Documents/PROJECT WEB APP/2.Web Task Development/src/components/FrontendCanvasViewer.tsx';

const componentCode = `import React, { useState, useEffect, useRef, useCallback, useMemo } from "react";
...
fs.writeFileSync(targetFilePath, componentCode, 'utf8');
console.log('Successfully updated FrontendCanvasViewer.tsx with clean sandbox & discussion support');
